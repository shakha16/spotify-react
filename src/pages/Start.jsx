...
function Start() {
    return (
        <>
            <div className="w-[100%] flex h-[100vh] flex-col items-center bg-[#121212] gap-1 text-center mx-0">
                <img src="./public/icons/bg.png" className="w-[428px] h-[500px] bg-no-repeat object-cover object-center"/>
